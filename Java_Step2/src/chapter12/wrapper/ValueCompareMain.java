...
public class ValueCompareMain {
	...
	public static void main(String[] args) {
		...
		System.out.println("==언방싱한 후 결과: " + (obj1.intValue() == obj2.intValue())); // 내부
		...
		// 주소비교(오토박싱된 선언은 1byte내에서는 캐싱(cache)되어 같은 객체를 재사용)
		System.out.println("==결과: " + (obj3 == obj4));// 외부
		System.out.println("==언방싱한 후 결과: " + (obj3.intValue() == obj4.intValue())); // 내부
