...
public class Example01 {
	...
	public static void main(String[] args) {
		...
		/*
		 * String WI="wizard"; String FI="fire"; String
		 * wizard=JOptionPane.showInputDialog("이름"); if(WI.equals(wizard)){ String
		 * fire=JOptionPane.showInputDialog("Quiz"); if(FI.equals(fire)) {
		 * System.out.println(wizard+"님 정답입니다 동굴의 문이 열립니다."); }else {
		 * System.out.println("틀렸습니다. 도망치세요"); } }else {
